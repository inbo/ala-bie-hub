    ...
    <div class="row taxon-row">
                            ...
                            <g:each in="${tc.conservationStatuses.entrySet().sort { it.key }}" var="cs">
                                <li>
                                    <g:if test="${cs.value.dr}">
                                        <a href="${speciesListUrl}/speciesListItem/list/${cs.value.dr}"><span
        ...
        <div class="col-md-6">
            ...
            <div class="taxon-map">
                ...
                <g:else>
                    <g:set var="mapUrl">${biocacheUrl}/occurrences/search?q=lsid:${tc?.taxonConcept?.guid}${grailsApplication.config.qualityProfile ? '&qualityProfile=' + grailsApplication.config.qualityProfile : ''}#tab_mapView</g:set>
                </g:else>
